...
int main(int argc, char *argv[])
{
  ...
  // if (parseout.size() != arch_65816.size())
  // {
  //   std::cout << "Size mismatch: (" << parseout.size() << ", " << arch_65816.size() << ")" << std::endl;
  // }
  // else
  // {
  //   int diffs = 0;
  ...
  //   {
  //     if (parseout[i] != arch_65816[i])
  //     {
  //       diffs += 1;
  //       std::cout << "Difference: (" << parseout[i] << ", " << arch_65816[i] << ") at " << i << std::endl;
  //     }
  //   }    
